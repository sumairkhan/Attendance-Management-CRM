<%@ Page Title="" Language="VB" MasterPageFile="~/Admin/Site.master" AutoEventWireup="false"
    CodeFile="Default.aspx.vb" Inherits="Admin_Attendance_Default" %>
                    ...
                    <ContentTemplate>
                        ...
                        <div class="form-group col-sm-4">
                            ...
                            <div class="col-sm-8" style="text-align: left;">
                                <asp:DropDownList runat="server" ID="ddlAttStatus" CssClass="form-control">
                                    ...
                                    <asp:ListItem Text="Holiday" Value="2"></asp:ListItem>
                                </asp:DropDownList>
                            </div>
                        </div>
                        <div class="clearfix">
                        ...
                        <div class="form-group col-sm-4">
                            <label class="col-sm-4 control-label" style="padding-right: 0px;">
                                Present Type:</label>
                            <div class="col-sm-8" style="text-align: left;">
                                <asp:DropDownList runat="server" ID="ddlPresentStatus" CssClass="form-control">
                                    <asp:ListItem Text="-- All --" Value=""></asp:ListItem>
                                    <asp:ListItem Text="Late Arrived" Value="1"></asp:ListItem>
                                    <asp:ListItem Text="Early Going" Value="2"></asp:ListItem>
                                    <asp:ListItem Text="Overtime" Value="3"></asp:ListItem>
                                </asp:DropDownList>
                            </div>
                        </div>
                        <div class="form-group col-sm-4">
