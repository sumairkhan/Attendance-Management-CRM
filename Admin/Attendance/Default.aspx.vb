...
Partial Class Admin_Attendance_Default
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not Page.IsPostBack Then
            ...
            Dim haveRights = PortalUtilities.fnHaveRights(lstEmployeeAndCompanyID(0), PortalUtilities.MenuLinks.Att_List)
    ...
    Protected Sub grd_RowDataBound(sender As Object, e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles grd.RowDataBound
        If e.Row.RowType = DataControlRowType.DataRow Then
            ...
            Try
                ...
                If Not String.IsNullOrEmpty(ddlPresentStatus.SelectedValue) AndAlso ddlPresentStatus.SelectedValue = 3 Then
    ...
    Private Sub BindGrid(ByVal cntx As PortalModel.PortalEntities)
        ...
        If Not String.IsNullOrEmpty(ddlPresentStatus.SelectedValue) Then
            If ddlPresentStatus.SelectedValue = 1 Then
                boolIsLateArrived = True
            ElseIf ddlPresentStatus.SelectedValue = 2 Then
                boolIsEarlyGoing = True
            End If
        End If
