...
Partial Class Admin_Attendance_EmpList
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not Page.IsPostBack Then
            ...
            Dim haveRights = PortalUtilities.fnHaveRights(lstEmployeeAndCompanyID(0), PortalUtilities.MenuLinks.Att_Employee_List)
    ...
    Protected Sub GetEmployees(cntx As PortalModel.PortalEntities)
        ...
        Dim objList = (From emp In cntx.Employees
                       ...
                       Select emp.EmployeeID, EmpName = emp.EmpCode + " - " + emp.FirstName, d.Title).ToList()


        Dim obj = (From emp In objList
                   Select emp.EmployeeID, EmpName = emp.EmpName & "  (" & emp.Title & ")").ToList()
    ...
    Private Sub btnExport_Click(sender As Object, e As EventArgs) Handles btnExport.Click
        Try
            ...
            Response.AddHeader("content-disposition", "attachment;filename=EmployeeAttendanceList.xls")
            Response.Charset = ""
