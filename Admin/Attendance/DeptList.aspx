<%@ Page Title="" Language="VB" MasterPageFile="~/Admin/Site.master" AutoEventWireup="false"
    CodeFile="DeptList.aspx.vb" Inherits="Admin_Attendance_DeptList" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="PageHeading" runat="Server">
    <h1 class="page-title">Department's Attendance List</h1>
</asp:Content>
                    ...
                    <ContentTemplate>
                        ...
                        <div class="form-group col-sm-4">
                            ...
                            <div class="col-sm-8" style="text-align: left;">
                                <asp:DropDownList runat="server" ID="ddlDept" CssClass="form-control" Width="100%">
                                </asp:DropDownList>
