<%@ Page Title="" Language="VB" MasterPageFile="~/Admin/Site.master" AutoEventWireup="false" CodeFile="Default.aspx.vb" Inherits="Admin_Setup_Scales_Default" %>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            dataSource = new kendo.data.DataSource({
                transport: {
                    read: {
                        url: "scales.ashx?action=1",
                        dataType: "json"
                    },
                    update: {
                        url: "scales.ashx?action=2",
                        dataType: "json"
                    },
                    destroy: {
                        url: "scales.ashx?action=4",
                        dataType: "json"
                    },
                    create: {
                        url: "scales.ashx?action=3",
                        dataType: "json"
                    },
                ...
                schema: {
                    ...
                    model: {
                        id: "ScaleID",
                        fields: {
                            ScaleID: { editable: false, nullable: true },
                        ...
                        command: [
                            { name: "edit" },
                            {
                                ...
                                click: function (e) {
                                    ...
                                    bootbox.dialog({
                                        message: "Are you sure to delete Scale: " + data.Title + "?",
